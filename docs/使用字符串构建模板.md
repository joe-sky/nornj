...
console.log(html);
/*输出html:
<div name="bar" name2="bar2" disabled id="test" id2="123" data-id(1)="test1" data-id(2)="test2" data-id(3)="test3">
...
5. 使用prop块定义节点参数的优先级会高于直接定义在节点的开始标签内，如例中(2)处的name属性就覆盖了节点标签中定义的name属性。
