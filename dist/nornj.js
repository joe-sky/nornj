...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return defineProp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return defineProps; });
/* harmony export (immutable) */ __webpack_exports__["j"] = arrayPush;
/* harmony export (immutable) */ __webpack_exports__["n"] = arraySlice;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = isArrayLike;
/* harmony export (immutable) */ __webpack_exports__["e"] = each;
/* harmony export (immutable) */ __webpack_exports__["f"] = trimRight;
...
/* harmony export (immutable) */ __webpack_exports__["m"] = obj;
/* harmony export (immutable) */ __webpack_exports__["l"] = clearQuot;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return extensionConfig; });
/* harmony export (immutable) */ __webpack_exports__["e"] = registerExpr;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return registerExtension; });
...
var exprs = {
        ...
        (function () {
          ...
          if (props.elseifs) {
            (function () {
              ...
              __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](props.elseifs, function (elseif, i) {
                if (!!elseif.value) {
                  ret = elseif.fn();
                  return false;
                } else if (i === l - 1) {
  ...
  each: function each(list, options) {
    ...
    if (list) {
      (function () {
        ...
        var props = options.props;
        __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](list, function (item, index, len) {
          var param = {
            data: item,
            index: index,
            fallback: true
        ...
        }, false, __WEBPACK_IMPORTED_MODULE_1__utils_tools__["d" /* isArrayLike */](list));
  ...
  spread: function spread(props, options) {
    __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](props, function (v, k) {
  ...
  list: function list() {
    ...
    if (last > 0) {
      var ret = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["n" /* arraySlice */](args, 0, last);
...
function registerExpr(name, expr, options) {
  var params = name;
  if (!__WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](name)) {
    params = {};
    params[name] = {
      expr: expr,
      options: options
  ...
  __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](params, function (v, name) {
    if (v) {
      var _expr = v.expr,
          _options = v.options;
...
function styleProps(obj) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](obj)) {
    return obj;
  }
  ...
  while (matchArr = pattern.exec(obj)) {
    ...
    //将连字符转为驼峰命名
    key = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["h" /* toCamelCase */](key);
...
function newContext(p2, p3) {
  ...
  return {
    data: newData.length ? __WEBPACK_IMPORTED_MODULE_1__utils_tools__["j" /* arrayPush */](newData, p2.data) : p2.data,
...
function tmplWrap(configs, main) {
  return function () {
    var initCtx = this,
        data = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["n" /* arraySlice */](arguments);

    return main(configs, {
      data: initCtx && initCtx._njData ? __WEBPACK_IMPORTED_MODULE_1__utils_tools__["j" /* arrayPush */](data, initCtx._njData) : data,
...
function template(fns) {
  var configs = {
    ...
    noop: __WEBPACK_IMPORTED_MODULE_1__utils_tools__["g" /* noop */],
    obj: __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */],
  ...
  __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](fns, function (v, k) {
    if (k.indexOf('main') === 0) {
      //将每个主函数构建为可运行的模板函数
...
var filters = {
  ...
  '#': function _(val, method) {
    if (val != null) {
      var args = arguments;
      return val[method].apply(val, __WEBPACK_IMPORTED_MODULE_1__utils_tools__["n" /* arraySlice */](args, 2, args.length - 1));
    }
...
function compileStringTmpl(tmpl) {
  ...
  if (!ret) {
    (function () {
      ...
      var isStr = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](tmpl),
          xmls = isStr ? [tmpl] : tmpl,
          l = xmls.length,
          fullXml = '';

      //Connection xml string
      __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](xmls, function (xml, i) {
        var split = '';
        if (i < l - 1) {
      ...
      __WEBPACK_IMPORTED_MODULE_1__utils_tools__["i" /* defineProp */](ret, '_njParamCount', {
        value: l - 1
      });
  ...
  var tmplFn = function tmplFn() {
    return __WEBPACK_IMPORTED_MODULE_0__core__["a" /* default */]['compile' + (outputH ? 'H' : '')](tmplFn, tmplKey).apply(this, params ? __WEBPACK_IMPORTED_MODULE_1__utils_tools__["j" /* arrayPush */]([params], arguments) : arguments);
  };
  __WEBPACK_IMPORTED_MODULE_1__utils_tools__["k" /* defineProps */](tmplFn, {
    _njTmpl: {
      value: ret
    },
    _njTmplKey: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_extension__ = __webpack_require__(2);
...
function getOpenTagParams(tag) {
  ...
  while (matchArr = pattern.exec(tag)) {
    ...
    if (value != null) {
      value = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["l" /* clearQuot */](value); //Remove quotation marks
    } else {
...
function isXmlCloseTag(obj, tagName) {
  return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](obj) && obj.toLowerCase() === '</' + tagName + '>';
}
...
function addTmpl(node, parent, name) {
  ...
  if (!paramsP) {
    paramsP = parent.params = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */]();
  }
...
function addParamsExpr(node, parent, isExprProp) {
  if (!parent.paramsExpr) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__utils_tools__["j" /* arrayPush */](parent.paramsExpr.content, isExprProp ? [node] : node.content);
  }
}
...
function compiledParams(obj) {
  var ret = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */]();
  __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](obj, function (v, k) {
    ...
    (function () {
      ...
      __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](filtersTmp, function (filter) {
        var retF = _getFilterParam(filter.trim()),
            filterObj = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */](),
        ...
        if (filterName) {
          ...
          if (paramsF) {
            (function () {
              var params = [];
              __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](paramsF.split(','), function (p) {
...
function compiledParam(value) {
  var ret = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */](),
      strs = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](value) ? value.split(tmplRule.replaceSplit) : [value],
      props = null,
  ...
  if (strs.length > 1) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](params, function (param) {
      var retP = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */]();
...
function _createCompile(outputH) {
  return function (tmpl, tmplKey, fileName) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](tmplKey)) {
      var options = tmplKey;
    ...
    if (!tmplFns) {
      var isObj = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](tmpl),
          fns = void 0;
      if (isObj && tmpl.main) {
        //直接传入预编译模板
        fns = tmpl;
        ...
        if (!root) {
          ...
          if (isObj && tmpl.type === 'nj_root') {
            ...
            if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](tmpl)) {
    ...
    if (tmpl._njParams) {
      var tmplFn = function tmplFn() {
        return tmplFns.main.apply(this, __WEBPACK_IMPORTED_MODULE_1__utils_tools__["j" /* arrayPush */]([tmpl._njParams], arguments));
      };
      __WEBPACK_IMPORTED_MODULE_1__utils_tools__["i" /* defineProp */](tmplFn, '_njTmpl', {
        value: true
      });
...
function _createAstRoot() {
  var root = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */]();
  root.type = 'nj_root';
  root.content = [];
...
function _createRender(outputH) {
  return function (tmpl, options) {
    return (outputH ? compileH : compile)(tmpl, options ? {
      ...
      fileName: options.fileName
    } : tmpl._njTmplKey).apply(null, __WEBPACK_IMPORTED_MODULE_1__utils_tools__["n" /* arraySlice */](arguments, 1));
  };
}
...
function registerComponent(name, component) {
  var params = name;
  if (!__WEBPACK_IMPORTED_MODULE_1__tools__["b" /* isObject */](name)) {
    params = {};
    params[name] = component;
  }

  __WEBPACK_IMPORTED_MODULE_1__tools__["e" /* each */](params, function (v, k) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_extension__ = __webpack_require__(2);
...
function _buildFn(content, node, fns, no, newContext, level, useStringLocal) {
  var fnStr = '',
      ...
      isTmplExpr = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](no),
...
function _buildPropData(obj, counter, fns, useStringLocal, level) {
  ...
  if (filters) {
    var _ret = function () {
      ...
      __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](filters, function (o) {
...
function _buildProps(obj, counter, fns, useStringLocal, level) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](str0)) {
    //常规属性
    valueStr = !obj.isAll && str0 !== '' ? '\'' + _replaceQuot(str0) + '\'' : '';
    filterStr = '';

    __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](obj.props, function (o, i) {
      var propData = _buildPropData(o, counter, fns, useStringLocal, level),
          dataValueStr = void 0;
      if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](propData)) {
  ...
  } else if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](str0) && str0.length != null) {
    //tmpl块表达式
    valueStr += '{\n';
    __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](str0, function (v, k, i, l) {
      if (k !== 'length') {
  ...
  if (params || paramsExpr) {
    ...
    if (paramsExpr) {
      ...
      if (!useString) {
        ...
        var keys = '';
        __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](params, function (v, k, i, l) {
          if (i == 0) {
            keys += '{ ';
          }
          keys += k + ': 1';
    ...
    if (params) {
      (function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](paramKeys, function (k, i) {
          var valueStr = _buildProps(params[k], counter, fns, useString, level);
          if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](valueStr)) {
...
function _buildNode(node, parent, fns, counter, retType, level, useStringLocal, isFirst) {
  ...
  if (node.type === 'nj_plaintext') {
    ...
    if (node.args) {
      //构建匿名参数
      __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](node.args, function (arg, i) {
    ...
    if (node.typeRefer) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["b" /* isObject */](valueStrT)) {
...
function _buildContent(content, parent, fns, counter, retType, level, useStringLocal) {
  ...
  __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](content, function (node) {
...
function checkElem(obj, parent, hasExprProps, noSplitNewline, isLast) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_1__utils_tools__["q" /* isArray */](obj)) {
    //判断是否为文本节点
    if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](obj)) {
      if (!noSplitNewline) {
        ...
        _plainTextNode(isLast && parent.allowNewline === 'nlElem' ? __WEBPACK_IMPORTED_MODULE_1__utils_tools__["f" /* trimRight */](obj) : obj, parent, parentContent, noSplitNewline);
      }
    } else {
  ...
  var node = {},
      first = obj[0];
  if (__WEBPACK_IMPORTED_MODULE_1__utils_tools__["c" /* isString */](first)) {
    //第一个子节点为字符串
    var len = obj.length,
        last = obj[len - 1],
        isElemNode = false,
    ...
    if (!expr) {
      ...
      if (exprParams != null && !isTmpl && !isParamsExpr) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](exprParams, function (param) {
          ...
          if (param.onlyBrace) {
            ...
            if (!node.params) {
              node.params = __WEBPACK_IMPORTED_MODULE_1__utils_tools__["m" /* obj */]();
            }
    ...
    if (isElemNode) {
      ...
      if (!expr) {
        ...
        if (tagParams) {
          ...
          __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](tagParams, function (param) {
...
function checkContentElem(obj, parent, hasExprProps, noSplitNewline) {
  ...
  __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e" /* each */](obj, function (item, i, l) {
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "isObject", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "isString", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "isArrayLike", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "each", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "trimRight", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["f"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "noop", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["g"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "toCamelCase", function() { return __WEBPACK_IMPORTED_MODULE_1__utils_tools__["h"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "exprs", function() { return __WEBPACK_IMPORTED_MODULE_5__helpers_extension__["a"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "extensions", function() { return __WEBPACK_IMPORTED_MODULE_5__helpers_extension__["b"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "exprConfig", function() { return __WEBPACK_IMPORTED_MODULE_5__helpers_extension__["c"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "extensionConfig", function() { return __WEBPACK_IMPORTED_MODULE_5__helpers_extension__["d"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "registerExpr", function() { return __WEBPACK_IMPORTED_MODULE_5__helpers_extension__["e"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "registerExtension", function() { return __WEBPACK_IMPORTED_MODULE_5__helpers_extension__["f"]; });
