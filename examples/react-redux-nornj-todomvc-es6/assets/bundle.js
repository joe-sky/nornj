...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEmptyComponentRegistry = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nj = __webpack_require__(9),
	    ...
	    compiler = __webpack_require__(258),
	    compileStringTmpl = __webpack_require__(75),
	    tmplByKey = __webpack_require__(269),
	    docReady = __webpack_require__(260);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nj = __webpack_require__(9),
	    ...
	    tranParam = __webpack_require__(48),
	...
	function getOpenTagParams(obj, noXml) {
	  ...
	  while (matchArr = pattern.exec(obj)) {
	    var key = matchArr[1];
	    if (key === '/' || key === '/>') {
	      //If match to the last "/" or "/>", then continue the loop.
	      continue;
	    }
	...
	function getTagComponentAttrs(el) {
	  ...
	  tools.each(attrs, function (obj) {
	    ...
	    if (attrName !== nj.tagId && obj.specified) {
	      //此处如不判断specified属性,则低版本IE中会列出所有可能的属性
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nj = __webpack_require__(9),
	    tools = __webpack_require__(11),
	    tranElem = __webpack_require__(47),
	    REGEX_SPLIT = /\$\{\d+\}/,
	    tmplRule = nj.tmplRule,
	    shim = __webpack_require__(268);
	...
	function compileStringTmpl(tmpl) {
	  var tmplKey, ret;
	  if (this) {
	    //The "tmplKey" parameter can be passed by the "this" object.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tools = __webpack_require__(11),
	    transformElement = __webpack_require__(47),
	    transformParam = __webpack_require__(48),
	    transformData = __webpack_require__(259),
	    escape = __webpack_require__(261),
	    checkElem = __webpack_require__(255),
	    setComponentEngine = __webpack_require__(266),
	    registerComponent = __webpack_require__(264),
	    filter = __webpack_require__(263),
	    expression = __webpack_require__(262),
	    setTmplRule = __webpack_require__(267);
	...
	}, checkElem, setComponentEngine, registerComponent, filter, expression, tools, transformElement, transformParam, transformData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = __webpack_require__(146);

	var _Provider2 = _interopRequireDefault(_Provider);

	var _connect = __webpack_require__(147);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _compose = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddTodoTmpl = __webpack_require__(139);

	var _AddTodoTmpl2 = _interopRequireDefault(_AddTodoTmpl);
	...
	var template = _base2.default.compileComponent(_AddTodoTmpl2.default);
	...
	var AddTodo = function (_Component) {
	  ...
	  _createClass(AddTodo, [{
	    ...
	    value: function render() {
	      ...
	      return template({ handleClick: function handleClick(e) {
	...
	_base2.default.registerComponent({ AddTodo: AddTodo });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FooterTmpl = __webpack_require__(141);
	...
	var SHOW_COMPLETED = _actions.VisibilityFilters.SHOW_COMPLETED;
	var SHOW_ALL = _actions.VisibilityFilters.SHOW_ALL;

	var template = _base2.default.compileComponent(_FooterTmpl2.default);
	...
	var Footer = function (_Component) {
	  ...
	  _createClass(Footer, [{
	    ...
	    value: function render() {
	      return template({
	        filters: [{ filter: SHOW_ALL, name: 'All' }, { filter: SHOW_COMPLETED, name: 'Completed' }, { filter: SHOW_ACTIVE, name: 'Active' }],
	...
	_base2.default.registerComponent({ Footer: Footer });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoTmpl = __webpack_require__(143);

	var _TodoTmpl2 = _interopRequireDefault(_TodoTmpl);
	...
	var template = _base2.default.compileComponent(_TodoTmpl2.default);
	...
	var Todo = function (_Component) {
	  ...
	  _createClass(Todo, [{
	    ...
	    value: function render() {
	      ...
	      return template([this.props, { click: function click(e) {
	...
	_base2.default.registerComponent({ Todo: Todo });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoListTmpl = __webpack_require__(142);

	var _TodoListTmpl2 = _interopRequireDefault(_TodoListTmpl);
	...
	var template = _base2.default.compileComponent(_TodoListTmpl2.default);
	...
	var TodoList = function (_Component) {
	  ...
	  _createClass(TodoList, [{
	    ...
	    value: function render() {
	      ...
	      return template([this.props, { todoClick: function todoClick(index) {
	...
	_base2.default.registerComponent({ TodoList: TodoList });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppTmpl = __webpack_require__(140);
	...
	var template = _base2.default.compileComponent(_AppTmpl2.default);
	  ...
	  _createClass(_App, [{
	    ...
	    value: function render() {
	      ...
	      return template([this.props, {
	        addClick: function addClick(text) {
	          return _this2.props.dispatch((0, _actions.addTodo)(text));
	        },
	        todoClick: function todoClick(index) {
	          return _this2.props.dispatch((0, _actions.completeTodo)(index));
	        }
	      }]);
	    }
	  }]);
	...
	var App = _base2.default.registerComponent('App', (0, _reactRedux.connect)(select)(_App));
...
/***/ function(module, exports, __webpack_require__) {
	...
	_base2.default.setComponentEngine('react', _react2.default, _reactDom2.default);
	_base2.default.registerComponent({
	  Provider: _reactRedux.Provider,
	  Router: _reactRouter.Router,
	  Route: _reactRouter.Route,
	  Redirect: _reactRouter.Redirect,
	  Linkto: _reactRouter.Link
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function visibilityFilter() {
	  ...
	  switch (action.type) {
	    case _reactRouterRedux.UPDATE_LOCATION:
	      var filter = action.payload.pathname.substr(1);
	      switch (filter) {
	        case '':
	        case 'all':
	          return _actions.VisibilityFilters.SHOW_ALL;
	        case 'active':
	          return _actions.VisibilityFilters.SHOW_ACTIVE;
	        case 'completed':
	          return _actions.VisibilityFilters.SHOW_COMPLETED;
	      }
	    default:
	      return state;
	  }
...
/***/ function(module, exports) {
	...
	var tmpl = {
	  ...
	  /**/) {
	    ...
	    var _dataRefer0 = [!p3.multiData ? data['filters'] : p1.getDatasValue(data, 'filters')];
...
/***/ function(module, exports) {
	...
	var tmpl = {
	  ...
	  /**/) {
	    ...
	    var _expr0 = p1.exprs['each'];
	    var _dataRefer0 = [!p3.multiData ? data['todos'] : p1.getDatasValue(data, 'todos')];
	    p1.throwIf(_expr0, 'each', 'expr');
...
/***/ function(module, exports, __webpack_require__) {
	...
	_base2.default.registerFilter({
	  isCurrent: function isCurrent(obj) {
	    return obj === this.parent.data.currentFilter;
	  },
	  todoState: function todoState(obj) {
	    switch (obj) {
	      case SHOW_ACTIVE:
	        return 'active';
	      case SHOW_COMPLETED:
	  ...
	  textDecoration: function textDecoration(obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(152),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateBrowserHistory = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nj = __webpack_require__(9),
	    ...
	    tranParam = __webpack_require__(48),
	    tranElem = __webpack_require__(47),
	    checkTagElem = __webpack_require__(256),
	    tmplRule = nj.tmplRule;
	...
	function checkElem(obj, parent) {
	  ...
	  if (tools.isString(first)) {
	    ...
	    if (xmlOpenTag) {
	      ...
	      if (!control) {
	        //tagname不为xml标签时,必须有结束标签才认为是元素节点
	        var openTag = tranElem.getOpenTag(first);
	        if (openTag) {
	          openTagName = openTag[0];

	          if (!tranElem.isSelfCloseTag(first)) {
	            //非自闭合标签
	        ...
	        if (tranElem.isControlCloseTag(last, ctrl)) {
	          //判断是否有流程控制块闭合标签
	          hasCloseTag = true;
	        }
	        isElemNode = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nj = __webpack_require__(9),
	    ...
	    replaceSpecialSymbol = __webpack_require__(265);
	...
	function _buildPropData(obj, counter, fns, noEscape) {
	  ...
	  if (filters) {
	    ...
	    utils.each(filters, function (o) {
	      ...
	      filterStr += '\n  ' + valueStr + ' = _filter' + _filterC + '.apply(_thisF' + _thisFC + ', [' + valueStr + (o.params ? o.params.reduce(function (p, c) {
	        return p + ', \'' + c + '\'';
	      }, '') : '') + ']);\n';
	      filterStr += '}\n';
	    }, false, true);
	...
	function _buildProps(obj, counter, fns) {
	  ...
	  } else if (utils.isObject(str0) && str0.length) {
	    //tmpl块表达式
	    valueStr += '{\n';
	...
	function _buildNode(node, fns, counter, retType) {
	  ...
	  if (node.type === 'nj_plaintext') {
	    ...
	    //子节点
	    fnStr += _buildContent(node.content, fns, counter, !useString ? { _compParam: '_compParam' + _compParamC } : { _children: '_children' + _childrenC });

	    //渲染
	    fnStr += _buildRender(3, retType, !useString ? { _compParam: _compParamC } : { _type: _typeC, _params: paramsStr !== '' ? _paramsC : null, _children: _childrenC, _selfClose: node.selfCloseTag }, fns);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nj = __webpack_require__(9),
	    utils = __webpack_require__(76),
	    buildRuntime = __webpack_require__(257),
	    compileStringTmpl = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function tmplWrap(configs, main) {
	  return function (data) {
	    ...
	    if (!configs.useString && tools.isArray(ret)) {
	      //组件最外层必须是单一节点对象
	      ret = ret[0];
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkStringElem = __webpack_require__(75);
